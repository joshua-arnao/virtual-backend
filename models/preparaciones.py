...
class Preparacion(conexion.Model):
    ...
    #Relación entre preparaciones y recetas
    recetas_id = Column(ForeignKey(column='recetas.id'), type_=types.Integer, nullable=False)
    ...
    receta = orm.relationship('Receta', backref='prepaciones')